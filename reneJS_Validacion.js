...
TipoDeValidacion.STR_SEGURIDAD_MINIMA_CONTRASENNA =()=>new  TipoDeValidacion((t,v) => {
...
class Validacion {
    ...
    addTexts_Contrasenna(id,idConfirmacion,condicionDeEvaluacion){
        let e=new ElementoParaValidacion(id,condicionDeEvaluacion);
        e.addTipoDeValidacion(TipoDeValidacion.STR_SEGURIDAD_MINIMA_CONTRASENNA());
        this.addElemento(e);
    ...
    addText_Contrasenna(id,condicionDeEvaluacion){
        let e=new ElementoParaValidacion(id,condicionDeEvaluacion);
        e.addTipoDeValidacion(TipoDeValidacion.STR_SEGURIDAD_MINIMA_CONTRASENNA());
        this.addElemento(e);
    ...
    addTexts_ContrasennaYAnterior(idContrasennaAnterior,id,idConfirmacion,condicionDeEvaluacion){
        let e=new ElementoParaValidacion(id,condicionDeEvaluacion);
        e.addTipoDeValidacion(TipoDeValidacion.STR_SEGURIDAD_MINIMA_CONTRASENNA());
        ...
        let e0=new ElementoParaValidacion(idContrasennaAnterior,condicionDeEvaluacion);
        e0.addTipoDeValidacion(TipoDeValidacion.STR_SEGURIDAD_MINIMA_CONTRASENNA());

        e.addTipoDeValidacion(new TipoDeValidacion((t,v)=>{

            return v!=getValue(idContrasennaAnterior);
        },
            "Tiene que ser una nueva contraseña distinta de la anterior "
        ));
        this.addElemento(e);
        this.addElemento(e2);
        this.addElemento(e0);
...
class ValidacionConEventos{
    ...
    addTexts_Contrasenna(id,idConfirmacion,condicionDeEvaluacion){
        let e=this.__AddElemento_V_D_Text([id,idConfirmacion],v=>v.addTexts_Contrasenna(id,idConfirmacion,condicionDeEvaluacion));
        return this;
    }
    addText_Contrasenna(id,condicionDeEvaluacion){
        let e=this.__AddElemento_V_D_Text(id,v=>v.addText_Contrasenna(id,condicionDeEvaluacion));
        return this;
    }
    addTexts_ContrasennaYAnterior(idContrasennaAnterior,idContrasennaNueva,idConfirmacion,condicionDeEvaluacion){
        let e=this.__AddElemento_V_D_Text([idContrasennaAnterior,idContrasennaNueva,idConfirmacion],v=>v.addTexts_ContrasennaYAnterior(idContrasennaAnterior,idContrasennaNueva,idConfirmacion,condicionDeEvaluacion));
        return this;
    }
